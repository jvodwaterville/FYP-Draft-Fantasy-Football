...
//set onClick functions for all player names
    ...
    document.getElementById('freeAgentTradeButton').setAttribute("onclick", "makeFreeAgentTrade()");
...
var playersInArray = [], playersOutArray = [];

//Global Arrays to hold ids of players in and players going out by position
var gksInArray = [], dfsInArray = [], mfsInArray = [], fwsInArray = [];
var gksOutArray = [], dfsOutArray = [], mfsOutArray = [], fwsOutArray = [];

//Global Variables to hold numbers of players in and out per position
var gkIn = 0, gkOut=0, dfIn=0, dfOut=0, mfIn=0, mfOut=0, fwIn=0, fwOut=0;
...
//makes the trade for free agents
function makeFreeAgentTrade()
{
    ...
    else if(gkIn == gkOut && dfIn == dfOut && mfIn == mfOut && fwIn == fwOut)
    {
        ...
        xmlhttp.open("GET","index.php?freeAgentsTrade=true" + transferPlayersIn + transferPlayersOut+"&squadid="+GETARRAY['squadid'] +"&leagueid="+GETARRAY['leagueid'], true);
        xmlhttp.send();
...
function changePage(id)
{
    ...
    var xmlhttp; 
        ...
        //make call to getFreeAgents() function in model league.php, with data created above
        xmlhttp.open("GET","index.php?getFreeAgents=true&page=" + id + "&position=" + pos + "&premTeam=" + team + "&name=" + name +  "&squadid="+GETARRAY['squadid'], true);
        xmlhttp.send();
}