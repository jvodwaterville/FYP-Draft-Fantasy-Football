...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="createLeagueForm" class="leagueForm">
            <div class="form">
                <label>League Name:</label> <input type="text" id="createLeagueName" name="leaguename" placeholder="League Name" required><br>
                <label>League Password:</label> <input type="text" id="createLeaguePassword" name="password" placeholder="password" required><br>
                <label>Draft Date:</label> <input type="date" id="createLeagueDate" name="date" required><br>
                <label>Draft Time:</label> <input type="time" id="createLeagueTime" name="time" required><br>
                ...
                <label>Team Name:</label> <input type="text" id="createLeagueTeamName" name="teamname" placeholder="Team Name" required><br>
        ...
        <div id="joinLeagueForm" class="leagueForm">
            <div class="form">
                <p id="warningLabel"></p></br>
                <label>League Id:</label> <input type="text" id="joinLeagueId" name="leagueid" placeholder="League Id" required><br>
                <label>League Password:</label> <input type="text" id="joinLeaguePassword" name="password" placeholder="Password" required><br>
                <label>Team Name:</label> <input type="text" id="joinLeagueTeamName" name="teamname" placeholder="Team Name" required><br>
