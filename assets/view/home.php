		...
		<div id="logInForm">
			<div id="logIn">
                <form name="login" class="forms" action="<?php $this->user->login();?>" method="post">
                    <h2>Log In</h2>
                    <input type="text" class="input" name="usernameLogIn" placeholder="Username" required><br>
                    <input type="password" class="input" name="passwordLogIn" placeholder="Password" required><br>
			...
			<h2>Enter details</h2>
                <form name="Register" class="forms" action="<?php $this->user->register();?>" method="post">
                    ...
                    <input type="email" class="input" name="email" placeholder="Email" minlength=6 required><br>
                    <input id="pass1" type="password" name="password" class="input" placeholder="Password" required><br>
                    <input id="pass2" type="password" class="input" onkeyup="checkPass(); return false;" placeholder="Re-enter Password" required><br>
